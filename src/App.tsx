...
export default function App() {
  ...
  // Mock capture: pretend two plates found using uploaded image
  ...
  // Mock verify: build vehicles from detections
  const handleVerify = () => {
    ...
    const mockVehicles: VehicleInfo[] = detections.map(d => ({
      ...base,
      placa: d.plate,
    }));
